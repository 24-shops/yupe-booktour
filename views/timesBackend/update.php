 ...
 **/
    $this->breadcrumbs = array(
        ...
        $model->id => array('/booktour/times/view', 'id' => $model->id),
        Yii::t('booktour', 'Редактирование'),
    );

    $this->pageTitle = Yii::t('booktour', 'Время - редактирование');
...
<div class="page-header">
    <h1>
        <?php echo Yii::t('booktour', 'Редактирование') . ' ' . Yii::t('booktour', 'Времени'); ?>        <br/>
